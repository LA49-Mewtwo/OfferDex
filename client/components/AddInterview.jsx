...
export default function AddOffer(props) {
    const handler = (e) => {
      ...
      const url = `http://localhost:${port}/newInterview`;
        ...
        <form onSubmit={handler} className="space-y-8 divide-y divide-gray-200">
            ...
            <div className="space-y-6 sm:pt-5 sm:space-y-5">
              <div>
                ...
                <p className="mt-1 max-w-2xl text-sm text-gray-500">
                  Yankun = secretly Mew. David = half-computer half-man. Trey = AWS master. Erica = tailwind ninja.
                </p>
              </div>
          ...
          <div className="pt-5">
            <div className="flex justify-end">
              <button
                type="button"
                onClick={() => props.addInterviewSwitch(false)}
